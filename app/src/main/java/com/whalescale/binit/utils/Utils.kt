...
import com.whalescale.binit.utils.Const.DEPOT_TYPE
...
import com.whalescale.binit.utils.Const.METAL_ITEMS_TYPE
import com.whalescale.binit.utils.Const.NOT_ACCEPTED_TYPE
import com.whalescale.binit.utils.Const.ORGANIC_TYPE
import com.whalescale.binit.utils.Const.OVERSIZE_TYPE
import com.whalescale.binit.utils.Const.RECYCLE_TYPE
import com.whalescale.binit.utils.Const.YARD_WASTE_TYPE
...
object Utils {
    ...
    fun saveAnimationState(animated: Boolean) {
        App.context.getSharedPreferences("APP", Context.MODE_PRIVATE).edit().putBoolean(MAIN_CATEGORY_ANIMATION, animated).apply()
    }
